...
public class UserIdRef {
    ...
    public UserIdRef setId(String id) {
        this.id = id;
        return this;
    }

    public UserIdRef(String id) {
        this.id = id;
    }
    ...
    public UserIdRef setFilterId(String filterId) {
    ...
    public UserIdRef setFilteringInformationHolder(FilteringInformationHolder filteringInformationHolder) {
